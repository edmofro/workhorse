...
- [ ] Mockups are listed in the files panel and viewable as artifacts alongside the chat (see `card-navigation.md`)
...
- [ ] The files panel reflects extracted specs immediately (user can click to open as an artifact and edit further)
...
> **~~Mockup panel placement:~~** Resolved — mockups are listed in the files panel and opened as artifacts alongside the chat. See `card-navigation.md`.
