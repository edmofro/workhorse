...
Creating a new card from the board starts with a single free-text prompt describing what the user wants to achieve. The AI generates a title and brief description from this input, then opens the card's chat tab so the user can begin the spec interview immediately.
...
- [ ] The board's "New card" button uses this AI-prompt flow — one text area, AI-generated title and description, navigates to chat
