    ...
    <div className="flex items-center gap-[6px]">
      ...
      {prUrl && (
        <a
          ...
          className="inline-flex items-center gap-[6px] px-3 py-2 rounded-[var(--radius-default)] text-xs font-medium bg-[var(--bg-surface)] text-[var(--text-secondary)] border border-[var(--border-default)] shadow-[var(--shadow-sm)] hover:bg-[var(--bg-hover)] transition-colors duration-100"
        >
