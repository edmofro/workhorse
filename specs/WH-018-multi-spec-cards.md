...
- The AI identifies which specs are needed based on the conversation and its codebase analysis
- For new features, the AI suggests which area and filename to use
- When the AI detects interactions with existing functionality, it proposes pulling in the relevant existing spec for editing
- The user can also browse the product's spec tree and manually add existing specs to the card
