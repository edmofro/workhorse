  ...
  return (
    <div className="group relative flex items-center rounded-[var(--radius-md)] transition-colors duration-100">
      ...
      {onAdd && (
        <button
          type="button"
          className="absolute right-1 p-1 rounded-[var(--radius-sm)] text-[var(--text-muted)] hover:text-[var(--text-secondary)] hover:bg-[var(--bg-hover)] cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-100 relative before:absolute before:inset-[-6px] before:content-['']"
          title="New"
          onClick={onAdd}
        >
          <Plus size={12} />
