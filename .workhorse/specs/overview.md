...
- [ ] User edits specs by clicking them in the files panel — opens the spec as an artifact alongside the chat. Edit button makes it editable in-place, chat stays visible
