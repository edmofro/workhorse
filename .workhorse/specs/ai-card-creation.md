...
- [ ] The user's typed input is used exactly as the card description — no AI rewriting or modification
- [ ] The input is sent to the AI to generate the card title only
...
- [ ] The generated title is a short phrase (five to eight words) summarising the intent, written in sentence case
