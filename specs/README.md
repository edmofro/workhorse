...
Structured specifications for the Workhorse project — a spec-driven development workbench.

## v1 overview
- [v1-overview.md](./v1-overview.md) — The full v1 scope, flow, and key decisions

## v1 features
- [WH-001: AI-driven spec interview](./WH-001-speculate.md) — The core spec interview flow
- [WH-002: Spec editor](./WH-002-spec-editor.md) — Rich editing of spec documents
- [WH-005: Commit specs to codebase](./WH-005-commit-specs.md) — Branch creation, PR, and implementation handoff
