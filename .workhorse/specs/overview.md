...
- [ ] The jockey (see `workflow-orchestration.md`) observes the conversation, tracks progress in the journal, and suggests next steps via pills and the journey bar
